...
- 受治理扩充包：22个、1,656行端点/记录
- 多目标材料索引：61个材料键，其中30个覆盖三类目标证据；12个为交联PU迁移层，5个为商业TPU应用实验层，3个为Elastollan/PCL直接形状记忆文献配方，4个为Tecoflex药物复合实验配方，2个为IIR-OH相邻PU耐久配方
...
1. 已完成QUB、DataInBrief、商业TPU疲劳、Elastollan/PCL、Tecoflex和IIR-OH耐久接入；下一批继续优先处理能让现有材料形成三目标闭合的TGA、循环或完整断裂数据。
