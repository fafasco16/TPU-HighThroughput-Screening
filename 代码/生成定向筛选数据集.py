...
- 受治理扩充包：20个、1,050行端点/记录
- 多目标材料索引：59个材料键，其中30个覆盖三类目标证据；12个为交联PU迁移层，5个为商业TPU应用实验层，3个为Elastollan/PCL直接形状记忆文献配方，4个为Tecoflex药物复合实验配方
...
1. 已完成QUB、DataInBrief、商业TPU疲劳、Elastollan/PCL直接恢复和Tecoflex多性能接入；下一批继续优先处理能让同一配方形成三目标闭合的循环或完整断裂数据。
