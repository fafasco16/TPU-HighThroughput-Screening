...
- 受治理扩充包：44个、2,511行端点/记录
- 多目标材料索引：85个来源—材料证据行、84个唯一材料键，其中38行覆盖三类目标证据、69行覆盖至少两类；两个独立来源均映射到同一EOS TPU 1301键。SLS来源新增31个工艺条件、140个金标准试样，但不增加化学材料数；210个银层试样保持隔离。其余迁移层继续按材料/配方/状态而非曲线点计数。
