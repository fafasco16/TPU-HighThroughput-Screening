        ...
        rows.append(
            {
                ...
                "dimethyl_carbonate_smiles": "COC(=O)OC",
                "hexane_1_6_diol_smiles": "OCCCCCCO",
                "hexane_1_6_diamine_smiles": "NCCCCCCN",
                "pcdl_number_average_molar_mass_g_mol": 1900.0,
                "pudl_number_average_molar_mass_g_mol": 740.0,
                **_derive_endpoints(tensile[["stress", "strain"]]),
                **extract_tga_endpoints(thermal),
                "polymer_family": "nonisocyanate_PHCU",
                "chemistry_mapping_status": "monomer_set_and_composition_mapped_exact_sequence_unresolved",
