...
DFT冻结二面角松弛8点中5点QCHEM收敛：脂肪族−180/−150/0°相对能为1.23/1.99/0 kcal mol⁻¹，−90°在50步后失败；芳香族0/150°为0/3.20 kcal mol⁻¹，−180/−90°失败。成功点最大角漂移0.00038°，相对刚性DFT最大松弛变化5.04 kcal mol⁻¹；原始归档SHA-256为`70ef7ea01dd0c093a5f038bc6d80360bfb2583d8e0838cad3b62ac80d038db3d`。`计算/现实MD/氨基甲酸酯松弛比较/`仅连接DFT与MM均完成的5点，所有非零角GAFF2相对能均高于DFT，最大差4.54 kcal mol⁻¹。3个DFT失败点不插值、不用刚性值替代；每家族收敛点少于4，完整周期重拟合继续阻断。
