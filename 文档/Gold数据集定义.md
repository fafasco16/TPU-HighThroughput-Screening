...
2. `结果/Gold_C_计算性能.csv.gz`：1,406,774 条计算数值，含结构族键、性质、数值、单位状态、方法家族、保真度、来源定位和准入状态；
3. `结果/Gold_E_实验表格.csv.gz`：5,230 条实验目标、逐试样端点、配方/工艺观测或动力学值，含配方/样品身份、条件上下文、实验协议、单位状态、来源定位和准入状态。
